...
const Package = () => {
  return (
    <div className="package-container">
      ...
      <div className="pacakge-grid-container">
        {packages.map((pkg, index) => (
          <div key={pkg.id} className="pacakge-grid-item">
            ...
            <div className="details">
              ...
              <p className="package-info">Rooms: {pkg.rooms} | Guests: {pkg.guests}</p>
              <p className="activities">{pkg.activities.join(" | ")}</p>
              <p><Link to={`/PackageDetail/${pkg.id}`} className="details-link">View Details</Link></p>
            </div>
          </div>
        ))}
      </div>
